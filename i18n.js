...
const I18N = {
  en: {
    ...
    cw_more_offers: 'More offers on page', cw_buy_link: '🛒 Buy via our link (no extra cost)',
    cw_disclosure: 'We may earn a small commission — no extra cost to you.', cw_close: 'Close',
  ...
  hinglish: {
    ...
    cw_more_offers: 'Page pe aur offers', cw_buy_link: '🛒 Hamare link se kharido (koi extra cost nahi)',
    cw_disclosure: 'Humein chhota commission mil sakta hai — aapko koi extra cost nahi.', cw_close: 'Band karo',
  ...
  hi: {
    ...
    cw_more_offers: 'Page पे aur offers', cw_buy_link: '🛒 हमारे link से खरीदो (कोई extra cost नहीं)',
    cw_disclosure: 'हमें छोटा commission मिल सकता है — आपको कोई extra cost नहीं।', cw_close: 'बंद करो',

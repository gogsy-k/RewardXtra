...
const I18N = {
  en: {
    ...
    cw_bin_title: '💳 Check a card for offers (first 6 digits only)',
    cw_bin_ph: 'First 6 digits of card',
    cw_bin_nooffer: 'no offer for this card on this page',
    cw_bin_unknown: 'card not recognised — add it in My Cards',
    cw_bin_hint: '⚠️ Bank-level hint — not every card qualifies. Confirm exact eligibility in the site’s own offer checker.',
  ...
  hinglish: {
    ...
    cw_bin_title: '💳 Kisi card pe offer check karo (sirf pehle 6 digit)',
    cw_bin_ph: 'Card ke pehle 6 digit',
    cw_bin_nooffer: 'is page pe iska koi offer nahi',
    cw_bin_unknown: 'card pehchana nahi — "My Cards" me add karo',
    cw_bin_hint: '⚠️ Bank-level hint — har card eligible ho zaroori nahi. Exact eligibility site ke apne checker me card daal ke confirm karo.',
  ...
  hi: {
    ...
    cw_bin_title: '💳 किसी card पर offer check करो (सिर्फ पहले 6 digit)',
    cw_bin_ph: 'Card के पहले 6 digit',
    cw_bin_nooffer: 'इस page पर इसका कोई offer नहीं',
    cw_bin_unknown: 'card पहचाना नहीं — "My Cards" में add करो',
    cw_bin_hint: '⚠️ Bank-level hint — हर card eligible हो ज़रूरी नहीं। Exact eligibility site के अपने checker में card डालकर confirm करो।',
